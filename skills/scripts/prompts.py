...
Produce a bug report listing every issue found with its **location** (quote the relevant text) and **description** (classify as Critical Error or Justification Gap). If no issues are found, state the solution is correct.
